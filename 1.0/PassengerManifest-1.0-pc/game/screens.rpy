        ...
        frame:
            ...
            vbox:
                ...
                bar:
                    ...
                    xmaximum 320
                    left_bar Solid(stat_tint(manifest_state.stats["analysis"]))
                ...
                bar:
                    ...
                    xmaximum 320
                    left_bar Solid(stat_tint(manifest_state.stats["empathy"]))
                    right_bar Solid("#2a2a2a")
                ...
                bar:
                    ...
                    xmaximum 320
                    left_bar Solid(stat_tint(manifest_state.stats["resilience"]))
                    right_bar Solid("#2a2a2a")
                ...
                bar:
                    ...
                    xmaximum 320
                    left_bar Solid(stat_tint(manifest_state.stats["authority"]))
                    right_bar Solid("#2a2a2a")
...
screen manifest_panel():
    ...
    modal False
    zorder 300
    on "show" action Function(manifest_state.mark_manifest_reviewed)
    ...
    frame:
        ...
        vbox:
            ...
            hbox:
                ...
                textbutton "Изучить досье (биографии)" action [ToggleVariable("manifest_show_bio"), Function(manifest_state.mark_manifest_reviewed)]
