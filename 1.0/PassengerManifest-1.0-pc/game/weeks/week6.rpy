...
label w6_between_6_7_scene:
    scene bg corridor
    $ pm_story_sfx("ominous_hum")
    na "Перед последним слотом корабль повторяет знакомый звук — тот самый низкий гул, который Эван слышал каждый цикл."
